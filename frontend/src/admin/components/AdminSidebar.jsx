    ...
    <aside className={sidebarClasses}>
      ...
      <div className="flex items-center justify-between h-16 px-4 border-b border-gray-700">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-[#8b5e3c] rounded-lg flex items-center justify-center font-bold text-lg">
            C
          </div>
          {isOpen && <span className="font-semibold text-lg">CasaWood</span>}
        </div>
        <button
